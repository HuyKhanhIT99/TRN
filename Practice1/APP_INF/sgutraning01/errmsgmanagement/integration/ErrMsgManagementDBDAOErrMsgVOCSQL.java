...
*@FileName : ErrMsgManagementDBDAOErrMsgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ErrMsgManagementDBDAOErrMsgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ErrMsgManagementDBDAOErrMsgVOCSQL(){
		setQuery();
		...
		query.append("FileName : ErrMsgManagementDBDAOErrMsgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
