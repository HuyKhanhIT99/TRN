...
*@FileName : CodeMgmtMasterVO.java
*@FileTitle : CodeMgmtMasterVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.clv.sgutraning01.codemanagement.vo;
...
public class CodeMgmtMasterVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CodeMgmtMasterVO> models = new ArrayList<CodeMgmtMasterVO>();
	...
	public CodeMgmtMasterVO() {}

	public CodeMgmtMasterVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String intgCdUseFlg, String mngTblNm, String ownrSubSysCd, String intgCdLen, String intgCdDatTpNm, String intgCdTpCd, String intgCdDesc, String intgCdNm, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CodeMgmtMasterVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CodeMgmtMasterVO[]
	 */
	public CodeMgmtMasterVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CodeMgmtMasterVO model = null;
	...
	public CodeMgmtMasterVO[] getCodeMgmtMasterVOs(){
		CodeMgmtMasterVO[] vos = (CodeMgmtMasterVO[])models.toArray(new CodeMgmtMasterVO[models.size()]);
		return vos;
	}
