...
*@FileName : SguTranningDBDAOJooCarrierVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SguTranningDBDAOJooCarrierVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SguTranningDBDAOJooCarrierVORSQL(){
		setQuery();
		...
		query.append("FileName : SguTranningDBDAOJooCarrierVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
