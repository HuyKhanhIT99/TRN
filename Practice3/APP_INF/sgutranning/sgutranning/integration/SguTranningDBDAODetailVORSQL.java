...
*@FileName : SguTranningDBDAODetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SguTranningDBDAODetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SguTranningDBDAODetailVORSQL(){
		setQuery();
		...
		query.append("FileName : SguTranningDBDAODetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
